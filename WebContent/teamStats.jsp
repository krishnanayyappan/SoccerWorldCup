...
<body>
		...
		<div class="header">
			<div class="header_resize">
				...
				<div class="logo">
					...
					<p align="center">
						<a href="welcome.jsp" target="_top"><span>Return to
								Main Page</span></a>
					</p>
				</div>
			</div>
	...
	<h4>View Team Stats - Question A</h4>
	<form name="TeamForm" action="TeamStats" method="post">
		<table>
			<tbody>
				<tr>
					...
					<td><input id="teamnameError" name="teamnameError"
						value="${TSerrorMsgs.teamnameError}" type="text"
						style="background-color: white; color: red; border: none; width: 500px"
	...
	<table class="myTable" border="1">
		<tr class="myTableRow">
			...
			<th class="myTableHead" width="50" align="center">Player No.</th>
		</tr>
